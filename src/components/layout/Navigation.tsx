  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className="fixed top-0 left-0 right-0 z-[100] px-8 sm:px-14 lg:px-20 py-6 sm:py-8"
      >
        {/* Equal minmax(0,1fr) side tracks guarantee TRUE viewport centering of the links */}
        <div className="relative mx-auto max-w-[1400px] w-full grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center">
          ...
          >
            <span className="gradient-text font-heading font-black text-3xl sm:text-4xl lg:text-[40px] tracking-tight leading-none">
              Vertex
            </span>
            <span
              className="text-white font-bold text-3xl sm:text-4xl lg:text-[40px] tracking-tight leading-none opacity-95"
          ...
          {/* Right spacer on desktop; on mobile this column holds the menu button */}
          <div className="hidden lg:block" />

          {/* Mobile Menu Button */}
          <button
            className="lg:hidden relative z-[110] w-11 h-11 rounded-full bg-white/[0.06] border border-white/15 hover:border-cyan-400/60 flex flex-col items-center justify-center gap-1.5 transition-colors justify-self-end"
...
function NavLink({
  ...
  return (
    <a
      ...
      className="relative py-2 text-lg xl:text-xl font-medium transition-colors duration-200 group text-zinc-300 hover:text-white text-center"
    >
