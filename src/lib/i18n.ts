...
const pt = {
  ...
  metrics: {
    ...
    roi: "ROI Médio Clientes",
    years: "Anos de Experiência",
    uptime: "Uptime em Produção",
  },
  palette: {
  ...
  faq: {
    ...
    items: [
      {
        q: "Quanto investir em um projeto com a VertexTarget?",
        a: "Cada projeto é dimensionado sob medida a partir do retorno que você precisa. Começamos com um diagnóstico gratuito: entendemos suas metas, desenhamos o escopo ideal e apresentamos a proposta em até 48h — sem compromisso e sem pacotes genéricos.",
      },
      {
        q: "Qual é o prazo de entrega?",
        a: "Landing pages premium: 2–3 semanas. Sites institucionais: 4–6 semanas. Plataformas com automação e IA: 6–10 semanas. Você acompanha cada etapa com demos semanais — o cronograma combinado é o cronograma cumprido.",
      },
      {
        q: "Como funciona o suporte após a entrega?",
        a: "Todo projeto inclui 30 dias de suporte dedicado pós-launch: correções, ajustes finos e monitoramento. Depois, planos de manutenção contínua com SLA definido garantem que sua plataforma evolua junto com o negócio.",
      },
      {
        q: "Vocês atendem clientes internacionais?",
        a: "Sim — em português, inglês, espanhol, francês e italiano. O processo é 100% remoto e assíncrono, com reuniões no seu fuso. Já entregamos projetos para clientes em múltiplos estados e países.",
      },
      {
        q: "O que diferencia a VertexTarget?",
        a: "Engenharia de software de alto nível e estratégia comercial na mesma casa — as duas pontas que agências tradicionais separam. Sua plataforma não é só impecável: ela é projetada para gerar receita. E você fala diretamente com os CEOs, sem intermediários.",
      },
    ],
  },
  caseStudy: {
    ...
    layers: "Arquitetura & Camadas",
    features: "Funcionalidades",
    challenges: "Desafios & Soluções",
    results: "Resultados",
    liveLabel: "Projeto no ar",
    visit: "Visitar Projeto",
    notFound: "Estudo não encontrado.",
  },
  footer: {
...
const en: Dict = {
  ...
  testimonials: {
    title: "Those who hire us, recommend us.",
  },
  metrics: {
  ...
  faq: {
    ...
    items: [
      {
        q: "How much should I invest in a VertexTarget project?",
        a: "Every project is sized around the return you need. We start with a free diagnosis: we understand your goals, design the ideal scope and deliver a proposal within 48h — no commitment, no generic packages.",
      },
      {
        q: "What is the delivery timeline?",
        a: "Premium landing pages: 2–3 weeks. Institutional sites: 4–6 weeks. Platforms with automation and AI: 6–10 weeks. You follow every step with weekly demos — the schedule we agree on is the schedule we keep.",
      },
      {
        q: "How does post-launch support work?",
        a: "Every project includes 30 days of dedicated post-launch support: fixes, fine-tuning and monitoring. After that, ongoing maintenance plans with a defined SLA keep your platform evolving with your business.",
      },
      {
        q: "Do you serve international clients?",
        a: "Yes — in Portuguese, English, Spanish, French and Italian. The process is 100% remote and asynchronous, with meetings in your timezone. We've delivered for clients across multiple states and countries.",
      },
      {
        q: "What sets VertexTarget apart?",
        a: "High-level software engineering and commercial strategy under one roof — the two ends traditional agencies keep separate. Your platform isn't just flawless: it's engineered to generate revenue. And you talk directly with the CEOs, no middlemen.",
      },
    ],
  },
  caseStudy: {
...
const es: Dict = {
  ...
  testimonials: {
    title: "Quien contrata, recomienda.",
  },
  metrics: {
    projects: "Proyectos Entregados",
    roi: "ROI Medio Clientes",
    years: "Años de Experiencia",
    uptime: "Uptime en Producción",
  },
  palette: {
  ...
  faq: {
    ...
    items: [
      {
        q: "¿Cuánto invertir en un proyecto con VertexTarget?",
        a: "Cada proyecto se dimensiona según el retorno que necesitas. Empezamos con un diagnóstico gratuito: entendemos tus metas, diseñamos el alcance ideal y presentamos la propuesta en hasta 48h — sin compromiso y sin paquetes genéricos.",
      },
      {
        q: "¿Cuál es el plazo de entrega?",
        a: "Landing pages premium: 2–3 semanas. Sitios institucionales: 4–6 semanas. Plataformas con automatización e IA: 6–10 semanas. Acompañas cada etapa con demos semanales — el cronograma acordado es el cronograma cumplido.",
      },
      {
        q: "¿Cómo funciona el soporte post-lanzamiento?",
        a: "Todo proyecto incluye 30 días de soporte dedicado post-lanzamiento: correcciones, ajustes finos y monitoreo. Después, los planes de mantenimiento continuo con SLA definido garantizan que tu plataforma evolucione con tu negocio.",
      },
      {
        q: "¿Atienden clientes internacionales?",
        a: "Sí — en portugués, inglés, español, francés e italiano. El proceso es 100% remoto y asíncrono, con reuniones en tu huso horario. Ya entregamos proyectos para clientes en múltiples estados y países.",
      },
      {
        q: "¿Qué diferencia a VertexTarget?",
        a: "Ingeniería de software de alto nivel y estrategia comercial en la misma casa — las dos puntas que las agencias tradicionales separan. Tu plataforma no es solo impecable: está diseñada para generar ingresos. Y hablas directamente con los CEOs, sin intermediarios.",
      },
    ],
  },
  caseStudy: {
...
const fr: Dict = {
  ...
  testimonials: {
    title: "Ceux qui nous engagent, nous recommandent.",
  },
  metrics: {
    projects: "Projets Livrés",
    roi: "ROI Moyen Clients",
    years: "Années d'Expérience",
    uptime: "Disponibilité Production",
  },
  palette: {
  ...
  faq: {
    ...
    items: [
      {
        q: "Combien investir dans un projet avec VertexTarget ?",
        a: "Chaque projet est dimensionné selon le retour que vous visez. Nous commençons par un diagnostic gratuit : nous comprenons vos objectifs, dessinons le périmètre idéal et présentons une proposition sous 48h — sans engagement ni forfaits génériques.",
      },
      {
        q: "Quel est le délai de livraison ?",
        a: "Landing pages premium : 2–3 semaines. Sites institutionnels : 4–6 semaines. Plateformes avec automatisation et IA : 6–10 semaines. Vous suivez chaque étape avec des démos hebdomadaires — le calendrier convenu est le calendrier respecté.",
      },
      {
        q: "Comment fonctionne le support après lancement ?",
        a: "Chaque projet inclut 30 jours de support dédié post-lancement : corrections, ajustements fins et monitoring. Ensuite, des plans de maintenance continue avec SLA défini font évoluer votre plateforme avec votre activité.",
      },
      {
        q: "Servez-vous des clients internationaux ?",
        a: "Oui — en portugais, anglais, espagnol, français et italien. Le processus est 100 % remote et asynchrone, avec des réunions à votre fuseau horaire. Nous avons déjà livré des projets pour des clients dans plusieurs états et pays.",
      },
      {
        q: "Qu'est-ce qui différencie VertexTarget ?",
        a: "L'ingénierie logicielle de haut niveau et la stratégie commerciale sous le même toit — les deux bouts que les agences traditionnelles séparent. Votre plateforme n'est pas seulement impeccable : elle est conçue pour générer du revenu. Et vous parlez directement aux CEO, sans intermédiaires.",
      },
    ],
  },
  caseStudy: {
...
const it: Dict = {
  ...
  testimonials: {
    title: "Chi ci sceglie, ci consiglia.",
  },
  metrics: {
    projects: "Progetti Consegnati",
    roi: "ROI Medio Clienti",
    years: "Anni di Esperienza",
    uptime: "Uptime in Produzione",
  },
  palette: {
  ...
  faq: {
    ...
    items: [
      {
        q: "Quanto investire in un progetto con VertexTarget?",
        a: "Ogni progetto è dimensionato in base al ritorno che cerchi. Iniziamo con una diagnosi gratuita: comprendiamo i tuoi obiettivi, disegniamo lo scope ideale e presentiamo una proposta entro 48h — senza impegno e senza pacchetti generici.",
      },
      {
        q: "Qual è il tempo di consegna?",
        a: "Landing page premium: 2–3 settimane. Siti istituzionali: 4–6 settimane. Piattaforme con automazione e IA: 6–10 settimane. Segui ogni fase con demo settimanali — il calendario concordato è il calendario rispettato.",
      },
      {
        q: "Come funziona il supporto post-lancio?",
        a: "Ogni progetto include 30 giorni di supporto dedicato post-lancio: correzioni, messa a punto e monitoraggio. Dopo, i piani di manutenzione continua con SLA definito fanno evolvere la tua piattaforma insieme al business.",
      },
      {
        q: "Servite clienti internazionali?",
        a: "Sì — in portoghese, inglese, spagnolo, francese e italiano. Il processo è 100% remoto e asincrono, con riunioni nel tuo fuso orario. Abbiamo già consegnato progetti per clienti in più stati e paesi.",
      },
      {
        q: "Cosa distingue VertexTarget?",
        a: "Ingegneria del software di alto livello e strategia commerciale sotto lo stesso tetto — le due estremità che le agenzie tradizionali separano. La tua piattaforma non è solo impeccabile: è progettata per generare fatturato. E parli direttamente con i CEO, senza intermediari.",
      },
    ],
  },
  caseStudy: {
    back: "Torna ai Casi",
    overview: "Panoramica",
    layers: "Architettura & Livelli",
    features: "Funzionalità",
    challenges: "Sfide & Soluzioni",
    results: "Risultati",
    liveLabel: "Progetto online",
    visit: "Visita il Progetto",
    notFound: "Studio non trovato.",
  },
  footer: {
