...
export const CASES: CaseStudy[] = [
  ...
  },
  {
    ...
    color: "#e11d48",
    year: "2026",
    liveUrl: "https://primeimports-nine.vercel.app/",
    metrics: "Ferrari · Porsche · McLaren · Showroom Privativo · Laudo 100%",
    client: "Prime Imports SP (Tatuapé / Anália Franco — SP)",
  },
  {
    id: "newjetcar",
    title: "NewJetCar Premium",
    ...
    color: "#14b8a6",
    year: "2026",
    liveUrl: "https://newjetcar-premium.vercel.app/",
    metrics: "Vistoria 150+ Pontos · 100% Perícia Aprovada · +15 Anos de Mercado",
    client: "NewJetCar Premium (Vinhedo — SP)",
  },
  {
    id: "avantgarde",
    title: "Avantgarde",
    ...
    color: "#a3e635",
    year: "2026",
    liveUrl: "https://avantgarde.com.br/",
    metrics: "20.000+ Clientes · Porsche · Ferrari · Lamborghini · Brabus",
    client: "Avantgarde Automóveis",
  },
  {
    id: "vertexcars",
    title: "VertexCars",
    ...
    color: "#38bdf8",
    year: "2026",
    liveUrl: "https://vertexcars.vercel.app/",
    metrics: "+1.400 Veículos Entregues · 4.9★ Google · 33 Anos de Tradição",
    client: "VertexCars (Minas Gerais)",
  },
  {
    id: "vertexjet",
    title: "VERTEX JET",
    ...
    color: "#8b5cf6",
    year: "2026",
    liveUrl: "https://vertexjet-alpha.vercel.app/",
