          ...
          {services.map((service) => (
            ...
            >
              <CardHeader className="text-center pb-4">
                ...
                <div className={`w-20 h-20 mx-auto mb-6 rounded-full bg-gradient-to-r ${service.gradient} flex items-center justify-center text-3xl group-hover:scale-110 transition-transform duration-300 shadow-lg group-hover:shadow-purple-500/50`}>
                  {service.icon}
                </div>
                  ...
                  <div className="border-t border-gray-700 pt-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {service.technologies.map((tech, index) => (
                        <Badge key={index} variant="outline" className="border-indigo-500/50 text-indigo-300 hover:bg-indigo-500/10">
                          {tech}
                        </Badge>
                      ))}
                    </div>
